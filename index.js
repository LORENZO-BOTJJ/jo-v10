/**
   * Create By LORENZO
   * Base by LORENZO
   * KALO LU HAPUS CHANEL YT CREDIT GA BAKALAN GW UPLOAD LAGI DAH DI KASIH FREE TOD
*/
...
loadDatabase()
    ...
    const jobotz = makeWASocket({
        ...
        browser: ['Daffaaa XD | (2022', 'Safari','1.0.0'],
        auth: state
    })
...
if (anu.action == 'add') {
 anunya =`
 Hello Kak....🤗!!!Selamat Datang Di Group Baru Semoga Kkak Nyaman Disini Selamat Bercanda!!!🐤
 ▰▱▰▱▰▱▰▱▰▱▰▱▰▱
╭│⃟🚫➢LORENZO BOT︎│⃟🚫➢
┃ ╭━━━━│⃟🚫➢
┃ ┃ ╭┈│⃟🚫➢
...
┃│⃟🚫➢ YOU TUBE 
┃│⃟🚫➢ LORENZO 𓆩🤗𓆪
┃│⃟🚫➢ https://youtube.com/@lorenzo7993
┃╰━│⃟🚫➢
╰│⃟🚫➢LORENZO BOT
...
©⏤͟͟͞│⃟🚫➢LORENZO BOT
`
jobotz.sendMessage(anu.id, { image:{ url: pp_user },
"contextInfo": {
"externalAdReply": {
"title": `│⃟🚫➢ 𝐖𝐄𝐋𝐂𝐎𝐌𝐄 │⃟🚫➢`,
"body":`│⃟🚫➢ 𝐁𝐑𝐎𝐃𝐇𝐄𝐑 │⃟🚫➢`,
...
"sourceUrl": `https://youtube.com/@lorenzo7993`,
"thumbnailUrl": 'https://telegra.ph/file/464fa49b626ed718a23db.jpg',
"contextInfo": {
"forwardingScore": 150,
"isForwarded": true
}
}},caption: anunya}, {quoted: m, contextInfo:{}})

 } else if (anu.action == 'remove') {
 anunya2 =`
 Good Bye 😓!!! Kalo Balik Lagi Bawa Gorengan 1 Kampung Ya TOD !!🐤
 ▰▱▰▱▰▱▰▱▰▱▰▱▰▱
╭│⃟🚫➢LORENZO BOT︎│⃟🚫➢
┃ ╭━━━━│⃟🚫➢
┃ ┃ ╭┈│⃟🚫➢
